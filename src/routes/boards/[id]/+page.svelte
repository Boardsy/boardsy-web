<script lang="ts">
	...
	function handleCardMove(
		event: CustomEvent<{ cardId: string; columnId: string; position: number }>
	) {
...
<div class="board-page">
	...
	{:else if $currentBoard}
		<div
			class="board-header"
			style={$currentBoard.backgroundColor
				? `background-color: ${$currentBoard.backgroundColor}`
				: ''}
		>
		...
		<div class="board-container">
			<div class="board-wrapper">
				{#each $currentBoard.columns as column (column.id)}
					<Column {column} on:cardMove={handleCardMove} on:cardReorder={handleCardReorder} />
				{/each}
